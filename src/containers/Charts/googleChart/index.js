...
const GoogleChart = (props) => <Async load={import(/* webpackChunkName: "googleChart" */ 'react-google-charts')}
                                      componentProps={props} componentArguement={'googleChart'}/>;
  ...
  render() {
    ...
    return (<LayoutWrapper className="isoMapPage">
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} xs={24} style={colStyle}>
          <Box
            title={configs.BubbleChart.title}
          >
            <ContentHolder>
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} xs={24} style={colStyle}>
          <Box
            title={configs.ScatterChart.title}
          >
            <ContentHolder>
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} xs={24} style={colStyle}>
          <Box
            title={configs.CandlestickChart.title}
          >
            <ContentHolder>
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        ...
        <Col md={12} xs={24} style={colStyle}>
          <Box
            title={configs.SteppedAreaChart.title}
          >
            <ContentHolder>

...
@inject(Keys.groupTaskOrderStatus)
@observer
export default class TaskOrderGroupStatuses extends PureComponent {

  constructor(props) {
    super(props);
    this.groupTaskOrderStatus = this.props.groupTaskOrderStatus;
  }

  componentDidMount() {
    this.groupTaskOrderStatus.getDataSource(!this.props.allStatus);
  }
  ...
  render() {
    ...
    let {dataSource, fetching} = this.groupTaskOrderStatus;

...
import {Checkbox, Form, Icon, Spin, Table, Tag, Tooltip} from 'antd';
          ...
          <div style={{wordBreak: 'keep-all', textAlign: 'justify'}}>
            {
              ...
              <Tooltip title={text.Address}>
                <span>
                  <b>
                    <Icon type="environment"/>{'Phát: '}
                  </b>
                  {text.Address}
                </span>
                <a
                  href={`https://www.google.com/maps/place/${text.Address}`}
                  target="_blank"
                  style={{marginLeft: '5px'}}
                >
                  <Icon type="global"/>
